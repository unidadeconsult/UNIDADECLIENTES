const ReportsModule = {
    ...
    render() {
        ...
        const inactiveClients = clients.filter(c => c.status !== 'inativo' && ClientsModule.daysSinceContact(c.lastContact) >= 30);
        ...
        container.innerHTML = `
            ...
            <div class="report-section">
                ...
                <div class="report-stats">
                    ...
                    <div class="report-stat">
                        <div class="report-stat-number">${ClientStore.getAllTags().length}</div>
                        <div class="report-stat-label">Etiquetas criadas</div>
                    </div>
                </div>
            </div>
        `;
